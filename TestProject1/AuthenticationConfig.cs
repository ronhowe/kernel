...
namespace TestProject1
{
    ...
    public class AuthenticationConfig
    {
        ...
        private string todoListBaseAddress = "";
        private string todoListScope = "";
        ...
        /// Web Api base URL
        /// </summary>
        public string TodoListBaseAddress { get => todoListBaseAddress; set => todoListBaseAddress = value; }

        /// <summary>
        /// Web Api scope. With client credentials flows, the scopes is ALWAYS of the shape "resource/.default"
        /// </summary>
        public string TodoListScope { get => todoListScope; set => todoListScope = value; }
